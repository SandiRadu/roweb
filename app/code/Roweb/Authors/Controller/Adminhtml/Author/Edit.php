...
class Edit extends \Roweb\Authors\Controller\Adminhtml\Author
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('roweb_authors_author', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? __('Edit Author %1', $model->getId()) : __('New Author'));
        return $resultPage;
    }
}